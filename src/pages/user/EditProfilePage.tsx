      ...
      <div className="w-full sm:max-w-[600px] p-5">
        <form onSubmit={handleSubmit(submitEditProfile)}>
          ...
          <div className="flex flex-col items-center w-full mb-5 pb-5 border-b-[1px] dark:border-gray-700">
            <Avatar name={userData.name} avatarUrl="" size="w-[90px] h-[90px]" textSize="text-4xl" bgColor={userData.bgColor} />
            <label
              htmlFor="avatar"
          ...
          <div className='mt-5'>
            <button type="submit" className="w-full sm:w-40 px-4 py-2 text-lg text-white rounded-md bg-green-600">修改</button>
          </div>
        </form>
      </div>
    );
